...
import { getGeneralBusinessHistory, getSingleBusinessHistory } from 'requests/allNegocios'
...
export const GeneralPaymentsTable = ({ dateRange }) => {
    ...
    React.useEffect(() => {
        async function getPurchaseHistory() {
            setLoading(true)
            const { success, response, error } = await getGeneralBusinessHistory(
                page,
